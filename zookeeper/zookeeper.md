# Zookeeper
最近发现很多分布式应用都在使用zookeeper这款服务，甚至不在Hadoop生态圈的很多服务也依赖zookeeper。  
但是一直没有系统整理学习过zookeeper，对于zookeeper是什么，有什么功能一直也没有明确的定义，故系统学习整理一份笔记。
参考 https://zhuanlan.zhihu.com/p/44731983
